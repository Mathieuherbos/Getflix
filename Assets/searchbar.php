     ...
     //SE CONNECTER A LA DB test
        ...
        $bdd = new PDO ('mysql:host=sql100.epizy.com;port=3306;dbname=epiz_26591763_catflix','epiz_26591763','nNU2fD6vzKC', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
            ...
            if(isset($_GET['search']) && $_GET['search'] == "")
                {   
                    echo '<h3 id="message">Nope! Couldn\'t find your movie, try again<h3>';
                    echo '<img id="grumpy" src="/assets/images/errorsearch_grumpy.png" alt="Grumpy cat" width="60%" height="60%">';
                ...
                //execute first request
                    $sqlrequest -> execute();
                        echo '<h3 id="message"><div class="animate__animated animate__tada"><b>Purrrfect!</b></div> You\'ve found it</h3><ul class="image-list-small">';
