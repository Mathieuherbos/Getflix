...
<style>
    ...
    <form method="post">
        ...
        <button type="submit" class="btn btn-danger" id="commentButton" <?php echo $disabled ?>>Submit <i class="fa fa-paw animate__animated animate__fadeIn" aria-hidden="true"></i></button>
    </form>
    <?php 
        if(isset($message)){
            echo $message;
